...
<<<<<<< HEAD:sdks/python/client/argo_workflows/model/io_argoproj_workflow_v1alpha1_artifact_result.py
...
>>>>>>> draft-3.6.5:sdks/python/client/argo_workflows/model/resource_claim.py
