...
=======
<<<<<<<< HEAD:sdks/python/client/argo_workflows/model/io_argoproj_workflow_v1alpha1_workflow_task_set_status.py
    Argo Workflows is an open source container-native workflow engine for orchestrating parallel jobs on Kubernetes. For more information, please see https://argo-workflows.readthedocs.io/en/release-3.5/  # noqa: E501
========
...
>>>>>>>> draft-3.6.5:sdks/python/client/argo_workflows/model/io_argoproj_workflow_v1alpha1_node_flag.py
>>>>>>> draft-3.6.5
