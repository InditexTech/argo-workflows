...
<<<<<<< HEAD:sdks/python/client/argo_workflows/model/io_argoproj_workflow_v1alpha1_artifact_node_spec.py
...
>>>>>>> draft-3.6.5:sdks/python/client/argo_workflows/model/app_armor_profile.py
